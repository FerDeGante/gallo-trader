    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <div className={styles.alert}>
          <p className={styles.reason}>Falta de Pago del Cliente</p>
        </div>

        <div className={styles.details}>
          <h2 className={styles.clientName}>Juan Luis Castillo Vargas</h2>
          <p className={styles.alias}>&quot;Gallo Trader&quot;</p>
        ...
        <div className={styles.social}>
          <p className={styles.socialLabel}>Redes Sociales del Deudor:</p>
          <div className={styles.socialLinks}>
            <a href="https://x.com/jlcastillovar" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
              <svg fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
              <span>@jlcastillovar</span>
            </a>
            <a href="https://instagram.com/gallo_trader/" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
              <svg fill="currentColor" viewBox="0 0 24 24">
              ...
              <span>@gallo_trader</span>
            </a>
            <a href="https://youtube.com/@gallotrader77" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
              <svg fill="currentColor" viewBox="0 0 24 24">
                <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" />
              </svg>
              <span>@gallotrader77</span>
            </a>
          </div>
        </div>
